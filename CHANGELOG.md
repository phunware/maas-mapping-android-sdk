...
- Removed one way routing feature flag in `PhunwareMapManager`
...
- Added new public API to query distance to POIs: `PhunwareMapManager.getShortestDistancesToAllPois(...)`
...
[4.5.0]: https://github.com/phunware/maas-mapping-android-sdk/compare/4.2.0...4.5.0
